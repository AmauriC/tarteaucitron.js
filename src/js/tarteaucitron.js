    ...
    tarteaucitron.addScript(pathToLang, '', function () {
      ...
      tarteaucitron.addScript(pathToServices, '', function () {
        ...
        if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.acceptAllCta) {
          ...
          html += '   </span>';
          //html += '   <span class="tarteaucitronAlertBigBtnWrapper">';
          if (tarteaucitron.parameters.acceptAllCta) {
            html += '   <button type="button" id="tarteaucitronAcceptAll" onclick="tarteaucitron.userInterface.respondAll(true);">';
            html += '       &#10003; ' + tarteaucitron.lang.acceptAll;
            html += '   </button>';
          }

          if (tarteaucitron.parameters.denyAllCta) {
            html += '   <button type="button" id="tarteaucitronDenyAll" onclick="tarteaucitron.userInterface.respondAll(false);">';
            html += '       &#10003; ' + tarteaucitron.lang.denyAll;
            html += '   </button>';
          }
