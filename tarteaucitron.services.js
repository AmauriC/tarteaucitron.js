...
tarteaucitron.services.piwikpro = {
  ...
  js: function() {
    ...
    tarteaucitron.addScript(
      'https://carsatse.containers.piwik.pro/' + tarteaucitron.user.piwikProId + '.js' + qPString
    )
...
tarteaucitron.services.xandrsegment = {
  ...
  js: function() {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'add_code=' + document.getElementById(uniqIds[i]).getAttribute('xandrsegmentAddCode') + '&'
      uri +=
        'remove=' + document.getElementById(uniqIds[i]).getAttribute('xandrsegmentRemove') + '&'
      uri +=
        'remove_code=' +
        document.getElementById(uniqIds[i]).getAttribute('xandrsegmentRemoveCode') +
        '&'
      uri +=
        'member=' + document.getElementById(uniqIds[i]).getAttribute('xandrsegmentMember') + '&'
...
tarteaucitron.services.xandrconversion = {
  ...
  js: function() {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'order_id=' +
        document.getElementById(uniqIds[i]).getAttribute('xandrconversionOrderId') +
        '&'
      uri +=
        'value=' + document.getElementById(uniqIds[i]).getAttribute('xandrconversionValue') + '&'
      uri +=
        'redir=' + document.getElementById(uniqIds[i]).getAttribute('xandrconversionRedir') + '&'
...
tarteaucitron.services.datingaffiliationpopup = {
  ...
  js: function() {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'submitconfig=' + document.getElementById(uniqIds[i]).getAttribute('submitconfig') + '&'
...
tarteaucitron.services.discord = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(['discord_widget'], function(x) {
      ...
      return (
        '<iframe width="' + width + '" height="' + height + '" src="' + widgetURL + '"></iframe>'
      )
    })
  },
  fallback: function() {
...
tarteaucitron.services.webtvnu = {
  ...
  js: function() {
    ...
    tarteaucitron.fallback(['webtvnu_player'], function(x) {
      var frame_url =
          'https://webtv.normandie-univ.fr/permalink/' + x.getAttribute('videoID') + '/iframe/',
        width = x.getAttribute('width'),
        height = x.getAttribute('height')
...
tarteaucitron.services.tiktok = {
  ...
  js: function() {
    ...
    tarteaucitron.addScript(
      'https://analytics.tiktok.com/i18n/pixel/sdk.js?sdkid=' + tarteaucitron.user.tiktokId
    )
