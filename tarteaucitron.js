...
var tarteaucitron = {
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.orientation === 'middle') {
                    var customThemeMiddle = document.createElement('style'),
                        cssRuleMiddle = 'div#tarteaucitronRoot.tarteaucitronBeforeVisible:before {content: \'\';position: fixed;width: 100%;height: 100%;background: white;top: 0;left: 0;z-index: 999;opacity: 0.5;}div#tarteaucitronAlertBig:before {content: \'' + tarteaucitron.lang.middleBarHead + '\';font-size: 35px;}body #tarteaucitronRoot div#tarteaucitronAlertBig {width: 60%;min-width: 285px;height: auto;margin: auto;left: 50%;top: 50%;transform: translate(-50%, -50%);box-shadow: 0 0 9000px #000;border-radius: 20px;padding: 35px 25px;}span#tarteaucitronDisclaimerAlert {padding: 0 30px;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {margin: 10px 0 30px;display: block;text-align: center;font-size: 21px;}@media screen and (max-width: 900px) {div#tarteaucitronAlertBig button {margin: 0 auto 10px!important;display: block!important;}}#tarteaucitronAlertBig.tarteaucitronAlertBigTop .tarteaucitronAlertBig-btn-close{right: 25px;top:1px;transform:translateY(-100%);}';
                ...
                if (tarteaucitron.orientation === 'popup') {
                    var customThemePopup = document.createElement('style'),
                        cssRulePopup = 'div#tarteaucitronAlertBig:before {content: \'' + tarteaucitron.lang.middleBarHead + '\';font-size: 22px;}body #tarteaucitronRoot div#tarteaucitronAlertBig {bottom: 0;top: auto!important;left: 8px!important;right: auto!important;transform: initial!important;border-radius: 5px 5px 0 0!important;max-width: 250px!important;width: Calc(100% - 16px)!important;min-width: 0!important;padding: 25px 0;}span#tarteaucitronDisclaimerAlert {padding: 0 30px;font-size: 15px!important;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {margin: 10px 0 30px;display: block;text-align: center;font-size: 21px;}div#tarteaucitronAlertBig button {margin: 0 auto 10px!important;display: block!important;width: Calc(100% - 60px);box-sizing: border-box;}#tarteaucitronAlertBig.tarteaucitronAlertBigTop .tarteaucitronAlertBig-btn-close{right: 6px;top:1px;transform:translateY(-100%);width:auto;}';
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                    html += '<div tabindex="-1" id="tarteaucitronAlertBig" role="dialog" class="tarteaucitronAlertBig' + orientation + '">';
                    //html += '<div class="tarteaucitronAlertBigWrapper">';
                    if(tarteaucitron.parameters.trapFocusToBanner){
                        html += '<button type="button" id="tarteaucitronAlertBigClose" class="tarteaucitronAlertBig-btn-close">'+tarteaucitron.lang.close+'</button>';
                    }
                ...
                if (tarteaucitron.parameters.adblocker === true) {
                    setTimeout(function () {
                        if (tarteaucitronNoAdBlocker === false) {
                            html = '<div id="tarteaucitronAlertBig" role="dialog" class="tarteaucitronAlertBig' + orientation + ' tarteaucitron-display-block" role="alert" aria-live="polite">';
                            if(tarteaucitron.parameters.trapFocusToBanner){
                                html += '<button type="button" id="tarteaucitronAlertBigClose" class="tarteaucitronAlertBig-btn-close">'+tarteaucitron.lang.close+'</button>';
                            }
                ...
                setTimeout(function () {
                    ...
                    tarteaucitron.addClickEventToId("tarteaucitronAlertBigClose", function () {
                        tarteaucitron.userInterface.closeAlert();
                        if(tarteaucitron.parameters.bodyPosition == 'bottom'){
                            var focusableEls = tarteaucitron.getAllFocusableElements(document.querySelector('body'));
    ...
    "userInterface": {
        ...
        "focusTrap": function(idToTrapFocusInside) {
            "use strict";
            ...
            if(idToTrapFocusInside == undefined){
                var idToTrapFocusInside = 'tarteaucitron';
            }
            focusableEls = document.getElementById(idToTrapFocusInside).querySelectorAll('a[href], button');
            filtered = [];
            ...
            document.getElementById(idToTrapFocusInside).addEventListener("keydown", function (evt) {
    ...
    "getAllFocusableElements":function(parent){
        ...
        )).filter(tarteaucitron.isVisible);
    },
